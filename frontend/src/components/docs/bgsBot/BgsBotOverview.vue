<template>
  <div>
    ...
    <h3>
      A
      <a href="https://discordapp.com/">Discord</a> bot for Elite Dangerous player groups. Track your player faction in
      Discord.
    </h3>
    <h2>Invite</h2>
    <v-btn
    ...
    <h2>Help</h2>
    <p>
      To get a complete idea of how to use the bot, go to the
