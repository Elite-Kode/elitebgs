...
<template>
  <div>
    <p>
      Welcome to my website. If you continue to browse and use this website, you are agreeing to comply with and be
      bound by the following terms and conditions of use, which together with my privacy policy govern Elite BGS's
    ...
    <p>
      The term 'Elite BGS' or 'me' or 'my' or 'I' refers to the owner of the website. The term 'you' refers to the user
      or viewer of my website.
    </p>
