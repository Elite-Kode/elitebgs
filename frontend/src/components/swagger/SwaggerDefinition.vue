      ...
      <v-simple-table dense class="elevation-1">
        ...
        <tbody>
          <tr v-for="property in getProperties()" :key="property">
            ...
            <td v-else-if="getProperty(property).type && getProperty(property).type === 'integer'">
              <a
            ...
            <td v-else-if="getProperty(property).$ref">
              ...
              &#60;
              <router-link :to="getDefinitionPath(getDefinitionFromRef(getProperty(property).$ref))">
            ...
            <td
              v-else-if="
                getProperty(property).type && getProperty(property).type === 'array' && getProperty(property).items.$ref
              "
            >
              <a
                href="https://developer.mozilla.org/en-US/docs/Glossary/array"
              ...
              &#60;
              <router-link :to="getDefinitionPath(getDefinitionFromRef(getProperty(property).items.$ref))">
