<template>
  <div>
    ...
    <v-btn-toggle multiple max="0">
      <v-btn color="primary" disabled> Monitor Station </v-btn>
      <v-btn
        color="primary"
    ...
    <v-row class="pt-8">
      <v-col cols="12" sm="12" md="6" lg="4" xl="3"> <b>Station Type : </b>{{ station.type }} </v-col>
      <v-col cols="12" sm="12" md="6" lg="4" xl="3"> <b>Government : </b>{{ station.government }} </v-col>
      <v-col cols="12" sm="12" md="6" lg="4" xl="3"> <b>Allegiance : </b>{{ station.allegiance }} </v-col>
      <v-col cols="12" sm="12" md="6" lg="4" xl="3"> <b>State : </b>{{ station.state }} </v-col>
      <v-col cols="12" sm="12" md="6" lg="4" xl="3"> <b>Economy : </b>{{ station.economy }} </v-col>
...
export default {
  ...
  methods: {
    ...mapMutations(['setSelectedStation']),
    formatDate(date) {
