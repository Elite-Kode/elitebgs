...
import { ISystem } from '../../main/systems/system.interface';
import { EBGSSystemsWOHistory, IngameIdsSchema } from '../../typings';
import { debounceTime, switchMap } from 'rxjs/operators';

@Component({
    selector: 'app-admin-systems-list',
    templateUrl: './admin-systems-list.component.html',
})
export class AdminSystemsListComponent implements OnInit, AfterViewInit {
